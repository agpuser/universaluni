 ...
 * Aaron Pethybridge
 * Student#: 217561644
 * Display furniture products page 
 *****************************************/
// Include functions
...
<body onload="loadCatalogXML('furniture')">
                    ...
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked category-menu">
                                <li class="active">
                                    <a onclick="getCatalogData('furniture')" href="#">furniture <span id="totalFurniture" class="badge pull-right">12</span></a>
                                    <ul>
                                        <li><a onclick="displayProductType('chair', 'furniture')" href="#">Chairs</a>
                                        </li>
                                        <li><a onclick="displayProductType('bed', 'furniture')" href="#">Beds</a>
                                        </li>												
                                        <li><a onclick="displayProductType('table', 'furniture')" href="#">Tables</a>
                                        </li>
										<li><a onclick="displayProductType('storage', 'furniture')" href="#">Storage</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
							...
							<form>						
								...
								<div class="widget-desc">
									<div class="slider-range">
										<div id="priceSlider" data-min="10" data-max="1000" data-unit="$" class="slider-range-price ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" data-value-min="10" data-value-max="1000" data-label-result="">
									...
									<button onclick="filterResultsBYPrice('priceSlider')" class="btn btn-default btn-sm btn-primary"><i class="fa fa-pencil"></i> Apply</button>
                                    ...
                                    <form class="form-inline">
                                        <div class="col-md-6 col-sm-6">
                                            <div id="switchNumbers" class="products-number">
												<!--
                                                <strong>Show</strong>  <a onclick="switchDisplayNumber(6)" href="#" class="btn btn-default btn-sm btn-primary">6</a>  <a onclick="switchDisplayNumber(12)" href="#" class="btn btn-default btn-sm">12</a>  <a href="#" class="btn btn-default btn-sm">All</a> products
												-->
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-6">
