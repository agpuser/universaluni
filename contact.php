...
<body>
	...
	foreach(glob('./captcha/*.png') as $file)
	{
		if(is_file($file))
			unlink($file);
	}
									   ...
									   && ($validationError == NONE))
	{
		...
		$sql = "INSERT INTO Contacts (contactfirstname, contactlastname, contactemail, contactsubject, contactmessage)
			VALUES ('$cfn','$cln','$ce','$cs','$cm')";
