 ...
 _________________________________________________________ -->
    ...
    <div id="all">
        ...
        <div id="content">
            <div class="container">
				<?php
				include 'sit203ass2utils.php';
				extract($_POST);
				$enteredFormValues = array($firstname);
				$enteredFormValues[] = $lastname;
					
				if (validatedAddressForm($enteredFormValues))
				{
					echo('<div class="col-md-12">');
						echo('<ul class="breadcrumb">');
							echo('<li><a href="index.html">Home</a>');
							echo('</li>');
                ...
                <div class="col-md-9" id="checkout">
                    ...
                    <div class="box">
                        <form method="post" action="checkout3.html">
							<?php
							if (addressFormValidated())
							{
								echo('<h1>Checkout - Payment method</h1>');
								echo('<ul class="nav nav-pills nav-justified">');
									echo('<li><a href="checkout1.html"><i class="fa fa-map-marker"></i><br>Address</a>');
									echo('</li>');
									echo('<li class="active"><a href="#"><i class="fa fa-money"></i><br>Payment Method</a>');
									echo('</li>');
									echo('<li class="disabled"><a href="checkout3.html"><i class="fa fa-eye"></i><br>Order Review</a>');
									echo('</li>');
								echo('</ul>');
							}
							?>
										...
										echo('<div class="row">');
											echo('<div class="box payment-method">');
												...
												echo('<div class="row">');
													...
													echo('</div>');
													echo('<div class="col-sm-10 form-group">');
														echo('<input type="text" name="cardnumber" placeholder="Card Number" maxlength="14"  class="form-control">');
													echo('</div>');
													echo('<div class="col-sm-4 form-group">');
														echo('<input type="text" name="expirymonth" placeholder="Expiry Month"  class="form-control">');
													echo('</div>');
													echo('<div class="col-sm-4 form-group">');
														echo('<input type="text" name="expiryyear" placeholder="Expiry Year"  class="form-control">');
													echo('</div>');
													echo('<div class="col-sm-4 form-group">');
                            ...
                            <div class="box-footer">
                                <div class="pull-left">
                                    <a href="checkout1.html" class="btn btn-default"><i class="fa fa-chevron-left"></i>Back to Address</a>
                                </div>
								<?php
								if (addressFormValidated())
								{
